...
from helpers.utils import decode_layer, TimingCallback, NumpyEncoder
from helpers.utils import get_public_key, get_private_key, NumpyDecoder, get_dataset_x, fetch_index, fetch_dataset
...
class VanillaClient:
    ...
    def end_training(self):
        pd.DataFrame.from_dict(self.record).to_csv(
            f"resources/results/vanilla_rsa/{self.dataset}/client_{self.client_id}.csv",
...
if __name__ == "__main__":
    print(f"EXPERIMENT: VANILLA RSA")
