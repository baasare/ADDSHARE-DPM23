...
from helpers.constants import NODES, ROUNDS, DATASET
from tensorflow.python.keras.models import model_from_json
from helpers.utils import generate_additive_shares, perform_exchange
from helpers.utils import decode_layer, TimingCallback, generate_groups, fetch_index, fetch_dataset, get_dataset_x
...
class AdditiveClient:
    ...
    def end_training(self, group):
        pd.DataFrame.from_dict(self.record).to_csv(
            f"resources/results/additive_groups_{group}/{self.dataset}/client_{self.client_id}.csv",
