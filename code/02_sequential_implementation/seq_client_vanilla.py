...
from helpers.utils import get_dataset_x, decode_layer, TimingCallback, fetch_dataset, fetch_index
...
class VanillaClient:
    ...
    def end_training(self):
        pd.DataFrame.from_dict(self.record).to_csv(
            f"resources/results/vanilla/{self.dataset}/client_{self.client_id}.csv",
