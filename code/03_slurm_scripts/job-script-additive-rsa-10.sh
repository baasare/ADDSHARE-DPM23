...
#SBATCH --job-name=additive-rsa-10
#SBATCH --output=outputs/output_additive-rsa-10-%j.out
# ---------------------------------------------------------------------
...
python ~/projects/def-pbranco/baasare/federated_learning/seq_client_additive_rsa_groups_10.py
# ---------------------------------------------------------------------
