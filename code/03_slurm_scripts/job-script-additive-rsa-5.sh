...
#SBATCH --job-name=additive-rsa-5
#SBATCH --output=outputs/output_additive-rsa-5-%j.out
# ---------------------------------------------------------------------
...
python ~/projects/def-pbranco/baasare/federated_learning/seq_client_additive_rsa_groups_5.py
# ---------------------------------------------------------------------
