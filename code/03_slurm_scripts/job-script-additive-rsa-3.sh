...
#SBATCH --job-name=additive-rsa-3
#SBATCH --output=outputs/output_additive-rsa-3-%j.out
# ---------------------------------------------------------------------
...
python ~/projects/def-pbranco/baasare/federated_learning/seq_client_additive_rsa_groups_3.py
# ---------------------------------------------------------------------
